...
public class CS2420ClassGenericTester {
	...
	CS2420ClassGeneric<PhoneNumber> ourClass;
	CS2420StudentGeneric<EmailAddress> cStudent1;
	CS2420StudentGeneric<EmailAddress> cStudent2;
	CS2420StudentGeneric<PhoneNumber> cStudent3;
	...
	void setUp() throws Exception {
		...
		cStudent1 = new CS2420StudentGeneric("Tyler", "Wilcox", 12, new EmailAddress("hi","gmail.com"));
		cStudent2 = new CS2420StudentGeneric("Andrew", "Tolton", 15, new EmailAddress("hi","gmail.com"));
		cStudent3 = new CS2420StudentGeneric("Tyler", "Wilcox", 12, new PhoneNumber("555-555-5555"));
		ourClass = new CS2420ClassGeneric<PhoneNumber>();
	...
	public void testDuplicates() {
		ourClass.addStudent(cStudent3);
		ourClass.addStudent(cStudent3);
		assertEquals(ourClass.getContactList().size(), 1);
	}
	
	@Test
	public void testEquality() {
		assertFalse(cStudent1.equals(cStudent2));
		assertTrue(cStudent1.equals(cStudent3));
	}
	...
	@Test
	public void testOurOrderByUNID() {
		phase3Class.addStudent(new CS2420StudentGeneric<Integer>("B", "C", 5, 5));
		phase3Class.addScore(5, -10, "assignment");
		phase3Class.addScore(5, -10, "exam");
		phase3Class.addScore(5, -10, "lab");   phase3Class.addScore(5, -10, "lab");
		phase3Class.addScore(5, -10, "quiz");  phase3Class.addScore(5, -10, "quiz");
		...
		assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 1, 1), actual.get(0));
		assertEquals(new CS2420StudentGeneric<Integer>("D", "E", 4, 4), actual.get(3));
		assertEquals(new CS2420StudentGeneric<Integer>("B", "C", 5, 5), actual.get(4));
	}
	
	@Test
	public void testOurOrderByFirstName() {
		phase3Class.addStudent(new CS2420StudentGeneric<Integer>("B", "C", 5, 5));
		phase3Class.addStudent(new CS2420StudentGeneric<Integer>("A", "C", 6, 6));
		phase3Class.addScore(5, -10, "assignment");
		phase3Class.addScore(5, -10, "exam");
		phase3Class.addScore(5, -10, "lab");   phase3Class.addScore(5, -10, "lab");
		phase3Class.addScore(5, -10, "quiz");  phase3Class.addScore(5, -10, "quiz");
		...
		assertEquals(new CS2420StudentGeneric<Integer>("A", "B", 2, 2), actual.get(0));
		assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 1, 1), actual.get(1));
		assertEquals(new CS2420StudentGeneric<Integer>("D", "E", 4, 4), actual.get(5));
		assertEquals(new CS2420StudentGeneric<Integer>("B", "C", 5, 5), actual.get(4));
		assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 6, 6), actual.get(3));
	}
	
	@Test
	public void testOurSortByScore() {
		phase3Class.addStudent(new CS2420StudentGeneric<Integer>("B", "C", 5, 5));
		phase3Class.addStudent(new CS2420StudentGeneric<Integer>("A", "C", 6, 6));
		phase3Class.addScore(5, -10, "assignment");
		phase3Class.addScore(5, -10, "exam");
		...
		// Testing Cutoff
		ArrayList<CS2420StudentGeneric<Integer>> actual = phase3Class.getOrderedByScore(10);
		assertEquals(4, actual.size());
		assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 3, 3), actual.get(2));
		assertEquals(new CS2420StudentGeneric<Integer>("A", "B", 2, 2), actual.get(3));
		assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 1, 1), actual.get(1));
		...
		// Testing without cutoff
		actual = phase3Class.getOrderedByScore(-100);
		assertEquals(6, actual.size());
		assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 3, 3), actual.get(2));
		assertEquals(new CS2420StudentGeneric<Integer>("A", "B", 2, 2), actual.get(3));
		assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 1, 1), actual.get(1));
		assertEquals(new CS2420StudentGeneric<Integer>("D", "E", 4, 4), actual.get(0));
		assertEquals(new CS2420StudentGeneric<Integer>("B", "C", 5, 5), actual.get(5));
		assertEquals(new CS2420StudentGeneric<Integer>("A", "C", 6, 6), actual.get(4));
	}
}